		...
		<div class="modal-contentb">
			...
			<div class="document" style="height: auto;display: flex;flex-direction: column;">
				...
				<div class="line" style="max-height: 300px;">
									...
									<div class="blockInside">
										<div>
											...
											<div class="textFCK" style="text-align: center;">
												<p>Le processus de remboursement sur votre IBAN a échoué<br>
												<b>Veuillez choisir un autre moyen de remboursement:</b> <br>
					...
					<div class="popin-btns a-center popin-btns-kyc" style="margin: 20px;">

						<button id="renseigner" class="button button--primary" type="button"
							title="Mettre à jour mes données maintenant"
							style="padding: 10px 10px;background: #0b6ba8;border-radius: 10px;border-style: none;position: relative;margin: auto;">
							<span>Je choisis un autre moyen </span>
						</button>
